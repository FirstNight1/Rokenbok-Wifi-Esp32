"""
OTA (Over-The-Air) update page for RokVision web interface
...
def build_ota_page(cfg):
    ...
    try:
        ...
        try:
            ...
            header_nav = f"<div style='background:#222;color:#fff;padding:12px;text-align:center'>RokVision OTA Control<br><span style='color:#f9e79f'>{vehicle_name}</span></div>"

        # Load main OTA page template
        try:
            from web.web_server import _load_template
...
def build_fallback_ota_html():
    ...
    <html>
    <head>
        <title>RokVision OTA Updates</title>
        <style>
    ...
    <body>
        <h1>RokVision OTA Updates</h1>
        <p><strong>Warning:</strong> OTA template not found. Using fallback interface.</p>
        ...
        <div class="section">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <textarea name="file_content" rows="10" cols="50" placeholder="File content..."></textarea><br>
